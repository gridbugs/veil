...
fn insert_change_move_remove() {
    ...
    assert_eq!(env.spatial_hash.get(Vector2::new(0, 0)).unwrap().enemy_set.len(), 1);
    ...
    assert_eq!(env.spatial_hash.get(Vector2::new(0, 0)).unwrap().enemy_set.len(), 0);
    ...
    assert_eq!(env.spatial_hash.get(Vector2::new(1, 1)).unwrap().enemy_set.len(), 1);
    ...
    assert_eq!(env.spatial_hash.get(Vector2::new(1, 1)).unwrap().enemy_set.len(), 0);
